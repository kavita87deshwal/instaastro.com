! function(e, t) {
    ...
    function v(e, t) {
        ...
        return t.code = e, t.name = c, Object.setPrototypeOf(t, v.prototype), Error.captureStackTrace && Error.captureStackTrace(t, y.prototype.create), t
    }
    var y = (m.prototype.create = function(e) {
        for (var t = [], r = 1; r < arguments.length; r++) t[r - 1] = arguments[r];
        for (var n, i = t[0] || {}, o = this.service + "/" + e, e = this.errors[e], e = e ? (n = i, e.replace(g, function(e, t) {
                var r = n[t];
                return null != r ? String(r) : "<" + t + "?>"
            })) : "Error", e = this.serviceName + ": " + e + " (" + o + ").", a = new p(o, e), s = 0, l = Object.keys(i); s < l.length; s++) {
            var c = l[s];
            "_" !== c.slice(-1) && (c in a && console.warn('Overwriting FirebaseError base field "' + c + '" can cause unexpected behavior.'), a[c] = i[c])
        }
        return a
    }, m);
    ...
    var C, D = [];
    (H = C = C || {})[H.DEBUG = 0] = "DEBUG", H[H.VERBOSE = 1] = "VERBOSE", H[H.INFO = 2] = "INFO", H[H.WARN = 3] = "WARN", H[H.ERROR = 4] = "ERROR", H[H.SILENT = 5] = "SILENT";
    ...
    var k = {
        ...
        T = C.INFO,
        x = ((V = {})[C.DEBUG] = "log", V[C.VERBOSE] = "log", V[C.INFO] = "info", V[C.WARN] = "warn", V[C.ERROR] = "error", V),
    ...
    (ee = re).INTERNAL.registerComponent(new I("platform-logger", function(e) {
        return new q(e)
    }, "PRIVATE")), ee.registerVersion(M, "0.6.11", te), ee.registerVersion("fire-js", "");
    return re.registerVersion("firebase", "7.24.0", "app"), re
});
